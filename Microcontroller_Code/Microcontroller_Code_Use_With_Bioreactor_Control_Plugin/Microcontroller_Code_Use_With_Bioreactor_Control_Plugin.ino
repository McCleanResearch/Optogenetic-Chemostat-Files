...
# define MEDIA_PUMP_RATIO 0.55 //Set these to be the same as the steady state calibreation file
# define SAMPLE_PUMP_RATIO 0.08
...
void readImmediateCommands(){
    ...
    sampleRatioOn=constrain(sampleRatioOn,0,1);
}
