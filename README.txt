...
vessel, and it can call external scripts for supplementary analysis or feedback control.
	...
	Fiji>Plugins>McCleanLab Analyze Bioreactor Images. Note that the images were collected
	...
	Fiji>File>Import>Image Sequence.
		YouTube demonstration: https://www.youtube.com/watch?v=LyaSNZRGDJk

	--To use the "Bioreactor_Controller.jar" to plot image analysis results, call the plugin from
	Fiji>Plugins>McCleanLab Plot Bioreactor Results. Note that the beginning of the video displays the CSV values that were
	...
	JHeatChart.jar to be in the Fiji/Jars folder.
		YouTube demonstration: https://youtu.be/8iOyvxAbDik
